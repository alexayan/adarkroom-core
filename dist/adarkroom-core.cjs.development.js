...
var Polyglot = _interopDefault(require('node-polyglot'));
...
var slice = /*#__PURE__*/toolkit.createSlice({
  name: 'marketing',
  initialState: {
    penrose: false
  },
...
var configSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'config',
  initialState: {
    hyperMode: false,
    soundOn: false
...
var locationSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'location',
  initialState: {
    Outside: false,
    Room: false,
...
var features = /*#__PURE__*/toolkit.combineReducers({
  location: location
});
var actions$3 = {
  location: actions$2
...
var storesSlice = /*#__PURE__*/toolkit.createSlice({
  name: 'stores',
...
var slice$1 = /*#__PURE__*/toolkit.createSlice({
  name: 'fire',
  initialState: {
...
var slice$2 = /*#__PURE__*/toolkit.createSlice({
  name: 'builder',
  initialState: {
    level: -1
  },
...
var slice$3 = /*#__PURE__*/toolkit.createSlice({
  name: 'temperature',
  initialState: {
...
var slice$4 = /*#__PURE__*/toolkit.createSlice({
  name: 'thieves',
  initialState: 0,
  reducers: /*#__PURE__*/_extends({}, numberValueModify, {
...
var slice$5 = /*#__PURE__*/toolkit.createSlice({
  name: 'stolen',
  initialState: /*#__PURE__*/getInitialState(),
  reducers: /*#__PURE__*/_extends({}, numberValueModify)
});
...
var slice$6 = /*#__PURE__*/toolkit.createSlice({
  name: 'stores',
  initialState: {},
  reducers: /*#__PURE__*/_extends({}, numberValueModify)
});
...
var slice$7 = /*#__PURE__*/toolkit.createSlice({
  name: 'population',
  initialState: {
    value: 0
  },
...
var slice$8 = /*#__PURE__*/toolkit.createSlice({
  name: 'workers',
  initialState: {},
  reducers: /*#__PURE__*/_extends({}, numberValueModify)
});
...
var slice$9 = /*#__PURE__*/toolkit.createSlice({
  name: 'city',
  initialState: {
    cleared: false
  },
...
var slice$a = /*#__PURE__*/toolkit.createSlice({
  name: 'world',
  initialState: {
    seenAll: false,
    mask: [],
...
var slice$b = /*#__PURE__*/toolkit.createSlice({
  name: 'space_ship',
  initialState: {
    hull: 0,
    thrusters: 1,
...
var slice$c = /*#__PURE__*/toolkit.createSlice({
  name: 'outside',
  initialState: {
    seenForest: false
  },
...
var game = /*#__PURE__*/toolkit.combineReducers({
  fire: fire,
  builder: builder,
...
var notify = /*#__PURE__*/toolkit.createAsyncThunk('notifications/notify', /*#__PURE__*/function () {
...
var storesSlice$1 = /*#__PURE__*/toolkit.createSlice({
  name: 'notifications',
  initialState: {
    notifyQueue: {
      global: []
...
var changeSpace = /*#__PURE__*/toolkit.createAsyncThunk('engine/changeSapce', /*#__PURE__*/function () {
...
var configSlice$1 = /*#__PURE__*/toolkit.createSlice({
  name: 'engine',
  initialState: {
    activeSubSpace: ''
  },
...
var slice$d = /*#__PURE__*/toolkit.createSlice({
  name: 'income',
  initialState: {},
  reducers: /*#__PURE__*/_extends({}, numberValueModify)
});
...
var addPerk = /*#__PURE__*/toolkit.createAsyncThunk('character/perks/add', /*#__PURE__*/function () {
...
var slice$e = /*#__PURE__*/toolkit.createSlice({
  name: 'perks',
...
var slice$f = /*#__PURE__*/toolkit.createSlice({
  name: 'statistics',
  initialState: {
    punches: 0,
    starved: 0,
...
var character = /*#__PURE__*/toolkit.combineReducers({
  perks: perks,
...
var storesSlice$2 = /*#__PURE__*/toolkit.createSlice({
  name: 'events',
  initialState: {
    eventStack: [],
    activeScene: '',
...
var storesSlice$3 = /*#__PURE__*/toolkit.createSlice({
  name: 'previous',
  initialState: {
    stores: [],
    score: 0
...
var slice$g = /*#__PURE__*/toolkit.createSlice({
  name: 'room',
  initialState: {
    changed: true,
    crafts: {},
...
var slice$h = /*#__PURE__*/toolkit.createSlice({
  name: 'outfit',
  initialState: {},
  reducers: /*#__PURE__*/_extends({}, numberValueModify, {
...
var path = /*#__PURE__*/toolkit.combineReducers({
  outfit: outfit
});
var actions$s = {
  outfit: actions$r
...
var slice$i = /*#__PURE__*/toolkit.createSlice({
  name: 'delay',
  initialState: {},
  reducers: /*#__PURE__*/_extends({}, numberValueModify)
});
...
var record = /*#__PURE__*/toolkit.createAsyncThunk('operation/record', /*#__PURE__*/function () {
...
var slice$j = /*#__PURE__*/toolkit.createSlice({
  name: 'operation',
  initialState: {},
  reducers: {
...
var reducer = /*#__PURE__*/toolkit.combineReducers({
  room: room,
  marketing: marketing,
  config: config,
  features: features,
...
operationManager.add({
  ...
  isAvailable: function isAvailable(engine) {
    var state = engine.getState();
    return !_.isEmpty(state.events.loot) && state.events.won && state.engine.activeSpace === exports.GameSpace.World;
  },
  meta: {
...
operationManager.add({
  ...
  isAvailable: function isAvailable(engine) {
    var state = engine.getState();
    return !_.isEmpty(state.game.world.outfit) && state.events.won && state.engine.activeSpace === exports.GameSpace.World;
  },
  meta: {
    space: exports.GameSpace.World
  },
...
//# sourceMappingURL=adarkroom-core.cjs.development.js.map
